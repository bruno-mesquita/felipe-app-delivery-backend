...
import { AddressClientRepository } from '../repository/AddressClientRepository';
import { AddressRepository } from '../../address/repository/AddressRepository';
import ClientRepository from '../../client/client.repository';
import { CreateAddressClient } from '../dtos/create-address-client';
import { schema } from '../validations/create-address-client';

class CreateAddressClientService {
...
export { CreateAddressClientService };
