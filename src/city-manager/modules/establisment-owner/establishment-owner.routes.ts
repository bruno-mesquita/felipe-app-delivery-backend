...
routes.post(
  ...
  ...middlewares,
  establishmentOwnerController.create
);
routes.get(
  '/establishment-owners',
  ...middlewares,
  establishmentOwnerController.list
);
routes.get(
  '/establishment-owners/:id',
  ...middlewares,
  establishmentOwnerController.show
);
routes.put(
  '/establishment-owners/:id',
  ...middlewares,
  establishmentOwnerController.update
);
