...
export class GenerateATicketService {
  ...
  async execute(ownerId: number, total: number, ticketId: number): Promise<ServiceResponse<any>> {
    try {
      ...
      ticket.link = mercadoPagoTicket.transaction_details.external_resource_url,
      ticket.status_detail = mercadoPagoTicket.status_detail,
      ticket.verification_code = mercadoPagoTicket.verification_code || mercadoPagoTicket.transaction_details.verification_code,
      ticket.payment_method_reference_id = mercadoPagoTicket.payment_method_reference_id || mercadoPagoTicket.transaction_details.payment_method_reference_id,
